...
plt.title("Agent Portfolio Value vs Market Price (Normalized % Change)")
plt.xlabel("Time (hours)")
plt.ylabel("Value (Starting = 100%)")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("exports/agent_vs_market.png", dpi=200)
print("Plot saved to exports/agent_vs_market.png")